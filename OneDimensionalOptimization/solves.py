from Optimization.OneDimensional.Parser import parser_task_gr
from Optimization.OneDimensional.GoldenRatio import golden_ratio
from Optimization.OneDimensional.parabols import parabolic_interpolation
from Optimization.OneDimensional.Brent import brent
...
def solve_golden_ratio(precision=1e-5, max_iter=500,
    ...
    if df.shape[0] != 0:
        display(df[['iter', 'point', 'function']])
